...
@rodata_15 = private unnamed_addr constant [34 x i8] c"\01\00\02\00Hello, World! 2\00Hello, World!\00", align 4, !ROData_SecInfo !0
...
entry:
  ...
  store i32 3, i32* %RBP_N.8, align 1
...
bb.1:                                             ; preds = %entry
  %EAX = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @rodata_15, i32 0, i32 4))
  br label %bb.3

bb.2:                                             ; preds = %entry
  %EAX1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @rodata_15, i32 0, i32 20))
  br label %bb.3
